...
class KeyItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`KeyItem <keyvault.models.KeyItem>` object
    """
...
class DeletedKeyItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedKeyItem <keyvault.models.DeletedKeyItem>` object
    """
...
class SecretItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`SecretItem <keyvault.models.SecretItem>` object
    """
...
class DeletedSecretItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedSecretItem <keyvault.models.DeletedSecretItem>` object
    """
...
class CertificateItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`CertificateItem <keyvault.models.CertificateItem>` object
    """
...
class CertificateIssuerItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`CertificateIssuerItem <keyvault.models.CertificateIssuerItem>` object
    """
...
class DeletedCertificateItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedCertificateItem <keyvault.models.DeletedCertificateItem>` object
    """
...
class StorageAccountItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`StorageAccountItem <keyvault.models.StorageAccountItem>` object
    """
...
class DeletedStorageAccountItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedStorageAccountItem <keyvault.models.DeletedStorageAccountItem>` object
    """
...
class SasDefinitionItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`SasDefinitionItem <keyvault.models.SasDefinitionItem>` object
    """
...
class DeletedSasDefinitionItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`DeletedSasDefinitionItem <keyvault.models.DeletedSasDefinitionItem>` object
    """
