...
class Action(Model):
    ...
    :type action_type: str or ~keyvault.models.ActionType
    """
...
class CertificateBundle(Model):
    ...
    :vartype policy: ~keyvault.models.CertificatePolicy
    ...
    :type attributes: ~keyvault.models.CertificateAttributes
...
class CertificateOperation(Model):
    ...
    :param issuer_parameters: Parameters for the issuer of the X509 component
     of a certificate.
    :type issuer_parameters: ~keyvault.models.IssuerParameters
    ...
    :type error: ~keyvault.models.Error
...
class CertificatePolicy(Model):
    ...
    :type key_properties: ~keyvault.models.KeyProperties
    :param secret_properties: Properties of the secret backing a certificate.
    :type secret_properties: ~keyvault.models.SecretProperties
    ...
    :type lifetime_actions: list[~keyvault.models.LifetimeAction]
    :param issuer_parameters: Parameters for the issuer of the X509 component
     of a certificate.
    :type issuer_parameters: ~keyvault.models.IssuerParameters
    :param attributes: The certificate attributes.
...
class Contacts(Model):
    ...
    :type contact_list: list[~keyvault.models.Contact]
    """
...
class SasDefinitionBundle(Model):
    ...
    :vartype sas_type: str or ~keyvault.models.SasTokenType
    ...
    :vartype attributes: ~keyvault.models.SasDefinitionAttributes
...
class SecretBundle(Model):
    ...
    :type attributes: ~keyvault.models.SecretAttributes
    :param tags: Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
...
class StorageAccountItem(Model):
    ...
    :vartype attributes: ~keyvault.models.StorageAccountAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
...
class KeyProperties(Model):
    ...
    :param key_type: The type of key pair to be used for the certificate.
     Possible values include: 'EC', 'EC-HSM', 'RSA', 'RSA-HSM', 'oct'
    :type key_type: str or ~keyvault.models.JsonWebKeyType
    :param key_size: The key size in bits. For example: 2048, 3072, or 4096
     for RSA.
    :type key_size: int
...
class LifetimeAction(Model):
    ...
    :type trigger: ~keyvault.models.Trigger
    :param action: The action that will be executed.
    :type action: ~keyvault.models.Action
    """
...
class OrganizationDetails(Model):
    ...
    :type admin_details: list[~keyvault.models.AdministratorDetails]
    """
...
class SasDefinitionCreateParameters(Model):
    ...
    :type sas_definition_attributes: ~keyvault.models.SasDefinitionAttributes
    :param tags: Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
    """
...
class X509CertificateProperties(Model):
    ...
    :type subject_alternative_names: ~keyvault.models.SubjectAlternativeNames
    :param key_usage: List of key usages.
    :type key_usage: list[str or ~keyvault.models.KeyUsageType]
