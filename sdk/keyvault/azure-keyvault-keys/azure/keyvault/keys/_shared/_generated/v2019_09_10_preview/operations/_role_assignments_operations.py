...
class RoleAssignmentsOperations(object):
    ...
    :ivar api_version: Client API version. Constant value: "2019-09-10-preview".
    """
    ...
    def __init__(self, client, config, serializer, deserializer):
        ...
        self.api_version = "2019-09-10-preview"

        self._config = config

    def delete(self, vault_base_url, scope, role_assignment_name, cls=None, **kwargs):
        ...
        :rtype: ~keyvault.models.RoleAssignment
    ...
    def create(self, vault_base_url, scope, role_assignment_name, properties, cls=None, **kwargs):
    ...
    def get(self, vault_base_url, scope, role_assignment_name, cls=None, **kwargs):
    ...
    def list_for_scope(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~keyvault.models.RoleAssignment]
        :raises: :class:`HttpResponseError<azure.core.HttpResponseError>`
        """
