...
class KeyVaultClientOperationsMixin(object):
    ...
    def create_key(self, vault_base_url, key_name, kty, key_size=None, key_ops=None, key_attributes=None, tags=None, release_policy=None, curve=None, cls=None, **kwargs):
    ...
    def get_key_versions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~keyvault.models.KeyItem]
        :raises:
         :class:`KeyVaultErrorException<keyvault.models.KeyVaultErrorException>`
        """
    ...
    def export(self, vault_base_url, key_name, key_version, target_environment, cls=None, **kwargs):
    ...
    def get_deleted_keys(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~keyvault.models.DeletedKeyItem]
        :raises:
         :class:`KeyVaultErrorException<keyvault.models.KeyVaultErrorException>`
        """
        def prepare_request(next_link=None):
